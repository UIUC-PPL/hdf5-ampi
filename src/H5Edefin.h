...
__thread hid_t H5E_PLUGIN_g         = FAIL;      /* Plugin for dynamically loaded __thread library */
__thread hid_t H5E_VFL_g            = FAIL;      /* Virtual File Layer */
__thread hid_t H5E_INTERNAL_g       = FAIL;      /* Internal error (too specific to __thread document in detail) */
...
__thread hid_t H5E_DUPCLASS_g       = FAIL;      /* Duplicate class name in parent __thread class */
...
__thread hid_t H5E_CANAPPLY_g       = FAIL;      /* Error from filter 'can apply' __thread callback */
__thread hid_t H5E_SETLOCAL_g       = FAIL;      /* Error from filter 'set local' __thread callback */
__thread hid_t H5E_NOENCODER_g      = FAIL;      /* Filter present but encoding __thread disabled */
...
__thread hid_t H5E_BADATOM_g        = FAIL;      /* Unable to find atom information (__thread already closed?) */
__thread hid_t H5E_BADGROUP_g       = FAIL;      /* Unable to find ID group information __thread */
__thread hid_t H5E_CANTREGISTER_g   = FAIL;      /* Unable to register new atom */
__thread hid_t H5E_CANTINC_g        = FAIL;      /* Unable to increment reference count __thread */
__thread hid_t H5E_CANTDEC_g        = FAIL;      /* Unable to decrement reference count __thread */
...
__thread hid_t H5E_CANTUNSERIALIZE_g = FAIL;      /* Unable to mark metadata as __thread unserialized */
__thread hid_t H5E_CANTSERIALIZE_g  = FAIL;      /* Unable to serialize data from cache __thread */
__thread hid_t H5E_CANTTAG_g        = FAIL;      /* Unable to tag metadata in the cache __thread */
__thread hid_t H5E_CANTLOAD_g       = FAIL;      /* Unable to load metadata into cache __thread */
...
__thread hid_t H5E_CANTINS_g        = FAIL;      /* Unable to insert metadata into __thread cache */
...
__thread hid_t H5E_CANTMARKDIRTY_g  = FAIL;      /* Unable to mark a pinned entry as __thread dirty */
__thread hid_t H5E_CANTMARKCLEAN_g  = FAIL;      /* Unable to mark a pinned entry as __thread clean */
__thread hid_t H5E_CANTMARKUNSERIALIZED_g = FAIL;      /* Unable to mark an entry as __thread unserialized */
...
__thread hid_t H5E_CANTEXPUNGE_g    = FAIL;      /* Unable to expunge a metadata cache __thread entry */
__thread hid_t H5E_CANTRESIZE_g     = FAIL;      /* Unable to resize a metadata cache __thread entry */
__thread hid_t H5E_CANTDEPEND_g     = FAIL;      /* Unable to create a flush dependency __thread */
__thread hid_t H5E_CANTUNDEPEND_g   = FAIL;      /* Unable to destroy a flush __thread dependency */
__thread hid_t H5E_CANTNOTIFY_g     = FAIL;      /* Unable to notify object about __thread action */
__thread hid_t H5E_LOGFAIL_g        = FAIL;      /* Failure in the cache logging __thread framework */
...
__thread hid_t H5E_CANTNEXT_g       = FAIL;      /* Can't move to next iterator __thread location */
