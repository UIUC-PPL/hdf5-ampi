...
__thread H5T_order_t H5T_native_order_g = H5T_ORDER_ERROR;
 ...
 */
__thread hid_t H5T_IEEE_F32BE_g			= FAIL;
__thread hid_t H5T_IEEE_F32LE_g			= FAIL;
__thread hid_t H5T_IEEE_F64BE_g			= FAIL;
__thread hid_t H5T_IEEE_F64LE_g			= FAIL;

__thread hid_t H5T_VAX_F32_g			= FAIL;
__thread hid_t H5T_VAX_F64_g			= FAIL;

__thread hid_t H5T_STD_I8BE_g			= FAIL;
__thread hid_t H5T_STD_I8LE_g			= FAIL;
__thread hid_t H5T_STD_I16BE_g			= FAIL;
__thread hid_t H5T_STD_I16LE_g			= FAIL;
__thread hid_t H5T_STD_I32BE_g			= FAIL;
__thread hid_t H5T_STD_I32LE_g			= FAIL;
__thread hid_t H5T_STD_I64BE_g			= FAIL;
__thread hid_t H5T_STD_I64LE_g			= FAIL;
__thread hid_t H5T_STD_U8BE_g			= FAIL;
__thread hid_t H5T_STD_U8LE_g			= FAIL;
__thread hid_t H5T_STD_U16BE_g			= FAIL;
__thread hid_t H5T_STD_U16LE_g			= FAIL;
__thread hid_t H5T_STD_U32BE_g			= FAIL;
__thread hid_t H5T_STD_U32LE_g			= FAIL;
__thread hid_t H5T_STD_U64BE_g			= FAIL;
__thread hid_t H5T_STD_U64LE_g			= FAIL;
__thread hid_t H5T_STD_B8BE_g			= FAIL;
__thread hid_t H5T_STD_B8LE_g			= FAIL;
__thread hid_t H5T_STD_B16BE_g			= FAIL;
__thread hid_t H5T_STD_B16LE_g			= FAIL;
__thread hid_t H5T_STD_B32BE_g			= FAIL;
__thread hid_t H5T_STD_B32LE_g			= FAIL;
__thread hid_t H5T_STD_B64BE_g			= FAIL;
__thread hid_t H5T_STD_B64LE_g 			= FAIL;
__thread hid_t H5T_STD_REF_OBJ_g 		= FAIL;
__thread hid_t H5T_STD_REF_DSETREG_g 		= FAIL;

__thread hid_t H5T_UNIX_D32BE_g			= FAIL;
__thread hid_t H5T_UNIX_D32LE_g			= FAIL;
__thread hid_t H5T_UNIX_D64BE_g			= FAIL;
__thread hid_t H5T_UNIX_D64LE_g 			= FAIL;

__thread hid_t H5T_C_S1_g			= FAIL;

__thread hid_t H5T_FORTRAN_S1_g			= FAIL;

__thread hid_t H5T_NATIVE_SCHAR_g		= FAIL;
__thread hid_t H5T_NATIVE_UCHAR_g		= FAIL;
__thread hid_t H5T_NATIVE_SHORT_g		= FAIL;
__thread hid_t H5T_NATIVE_USHORT_g		= FAIL;
__thread hid_t H5T_NATIVE_INT_g			= FAIL;
__thread hid_t H5T_NATIVE_UINT_g			= FAIL;
__thread hid_t H5T_NATIVE_LONG_g			= FAIL;
__thread hid_t H5T_NATIVE_ULONG_g		= FAIL;
__thread hid_t H5T_NATIVE_LLONG_g		= FAIL;
__thread hid_t H5T_NATIVE_ULLONG_g		= FAIL;
__thread hid_t H5T_NATIVE_FLOAT_g		= FAIL;
__thread hid_t H5T_NATIVE_DOUBLE_g		= FAIL;
#if H5_SIZEOF_LONG_DOUBLE !=0
__thread hid_t H5T_NATIVE_LDOUBLE_g		= FAIL;
#endif
__thread hid_t H5T_NATIVE_B8_g			= FAIL;
__thread hid_t H5T_NATIVE_B16_g			= FAIL;
__thread hid_t H5T_NATIVE_B32_g			= FAIL;
__thread hid_t H5T_NATIVE_B64_g			= FAIL;
__thread hid_t H5T_NATIVE_OPAQUE_g		= FAIL;
__thread hid_t H5T_NATIVE_HADDR_g		= FAIL;
__thread hid_t H5T_NATIVE_HSIZE_g		= FAIL;
__thread hid_t H5T_NATIVE_HSSIZE_g		= FAIL;
__thread hid_t H5T_NATIVE_HERR_g			= FAIL;
__thread hid_t H5T_NATIVE_HBOOL_g		= FAIL;

__thread hid_t H5T_NATIVE_INT8_g			= FAIL;
__thread hid_t H5T_NATIVE_UINT8_g		= FAIL;
__thread hid_t H5T_NATIVE_INT_LEAST8_g		= FAIL;
__thread hid_t H5T_NATIVE_UINT_LEAST8_g		= FAIL;
__thread hid_t H5T_NATIVE_INT_FAST8_g		= FAIL;
__thread hid_t H5T_NATIVE_UINT_FAST8_g		= FAIL;

__thread hid_t H5T_NATIVE_INT16_g		= FAIL;
__thread hid_t H5T_NATIVE_UINT16_g		= FAIL;
__thread hid_t H5T_NATIVE_INT_LEAST16_g		= FAIL;
__thread hid_t H5T_NATIVE_UINT_LEAST16_g		= FAIL;
__thread hid_t H5T_NATIVE_INT_FAST16_g		= FAIL;
__thread hid_t H5T_NATIVE_UINT_FAST16_g		= FAIL;

__thread hid_t H5T_NATIVE_INT32_g		= FAIL;
__thread hid_t H5T_NATIVE_UINT32_g		= FAIL;
__thread hid_t H5T_NATIVE_INT_LEAST32_g		= FAIL;
__thread hid_t H5T_NATIVE_UINT_LEAST32_g		= FAIL;
__thread hid_t H5T_NATIVE_INT_FAST32_g		= FAIL;
__thread hid_t H5T_NATIVE_UINT_FAST32_g		= FAIL;

__thread hid_t H5T_NATIVE_INT64_g		= FAIL;
__thread hid_t H5T_NATIVE_UINT64_g		= FAIL;
__thread hid_t H5T_NATIVE_INT_LEAST64_g		= FAIL;
__thread hid_t H5T_NATIVE_UINT_LEAST64_g		= FAIL;
__thread hid_t H5T_NATIVE_INT_FAST64_g		= FAIL;
__thread hid_t H5T_NATIVE_UINT_FAST64_g		= FAIL;
 ...
 */
__thread size_t H5T_NATIVE_SCHAR_COMP_ALIGN_g		= 0;
__thread size_t H5T_NATIVE_UCHAR_COMP_ALIGN_g		= 0;
__thread size_t H5T_NATIVE_SHORT_COMP_ALIGN_g		= 0;
__thread size_t H5T_NATIVE_USHORT_COMP_ALIGN_g   	= 0;
__thread size_t H5T_NATIVE_INT_COMP_ALIGN_g		= 0;
__thread size_t H5T_NATIVE_UINT_COMP_ALIGN_g		= 0;
__thread size_t H5T_NATIVE_LONG_COMP_ALIGN_g		= 0;
__thread size_t H5T_NATIVE_ULONG_COMP_ALIGN_g		= 0;
__thread size_t H5T_NATIVE_LLONG_COMP_ALIGN_g		= 0;
__thread size_t H5T_NATIVE_ULLONG_COMP_ALIGN_g	        = 0;
__thread size_t H5T_NATIVE_FLOAT_COMP_ALIGN_g		= 0;
__thread size_t H5T_NATIVE_DOUBLE_COMP_ALIGN_g	        = 0;
#if H5_SIZEOF_LONG_DOUBLE !=0
__thread size_t H5T_NATIVE_LDOUBLE_COMP_ALIGN_g	        = 0;
#endif

__thread size_t H5T_POINTER_COMP_ALIGN_g	                = 0;
__thread size_t H5T_HVL_COMP_ALIGN_g	                = 0;
__thread size_t H5T_HOBJREF_COMP_ALIGN_g	                = 0;
__thread size_t H5T_HDSETREGREF_COMP_ALIGN_g	        = 0;

/*
 * Alignment constraints for native types. These are initialized at run time
 * in H5Tinit.c
 */
__thread size_t H5T_NATIVE_SCHAR_ALIGN_g		= 0;
__thread size_t H5T_NATIVE_UCHAR_ALIGN_g		= 0;
__thread size_t H5T_NATIVE_SHORT_ALIGN_g		= 0;
__thread size_t H5T_NATIVE_USHORT_ALIGN_g	= 0;
__thread size_t H5T_NATIVE_INT_ALIGN_g		= 0;
__thread size_t H5T_NATIVE_UINT_ALIGN_g		= 0;
__thread size_t H5T_NATIVE_LONG_ALIGN_g		= 0;
__thread size_t H5T_NATIVE_ULONG_ALIGN_g		= 0;
__thread size_t H5T_NATIVE_LLONG_ALIGN_g		= 0;
__thread size_t H5T_NATIVE_ULLONG_ALIGN_g	= 0;
__thread size_t H5T_NATIVE_FLOAT_ALIGN_g		= 0;
__thread size_t H5T_NATIVE_DOUBLE_ALIGN_g	= 0;
#if H5_SIZEOF_LONG_DOUBLE !=0
__thread size_t H5T_NATIVE_LDOUBLE_ALIGN_g	= 0;
#endif
 ...
 */
__thread size_t H5T_NATIVE_INT8_ALIGN_g		= 0;
__thread size_t H5T_NATIVE_UINT8_ALIGN_g		= 0;
__thread size_t H5T_NATIVE_INT_LEAST8_ALIGN_g	= 0;
__thread size_t H5T_NATIVE_UINT_LEAST8_ALIGN_g	= 0;
__thread size_t H5T_NATIVE_INT_FAST8_ALIGN_g	= 0;
__thread size_t H5T_NATIVE_UINT_FAST8_ALIGN_g	= 0;

__thread size_t H5T_NATIVE_INT16_ALIGN_g		= 0;
__thread size_t H5T_NATIVE_UINT16_ALIGN_g	= 0;
__thread size_t H5T_NATIVE_INT_LEAST16_ALIGN_g	= 0;
__thread size_t H5T_NATIVE_UINT_LEAST16_ALIGN_g	= 0;
__thread size_t H5T_NATIVE_INT_FAST16_ALIGN_g	= 0;
__thread size_t H5T_NATIVE_UINT_FAST16_ALIGN_g	= 0;

__thread size_t H5T_NATIVE_INT32_ALIGN_g		= 0;
__thread size_t H5T_NATIVE_UINT32_ALIGN_g	= 0;
__thread size_t H5T_NATIVE_INT_LEAST32_ALIGN_g	= 0;
__thread size_t H5T_NATIVE_UINT_LEAST32_ALIGN_g	= 0;
__thread size_t H5T_NATIVE_INT_FAST32_ALIGN_g	= 0;
__thread size_t H5T_NATIVE_UINT_FAST32_ALIGN_g	= 0;

__thread size_t H5T_NATIVE_INT64_ALIGN_g		= 0;
__thread size_t H5T_NATIVE_UINT64_ALIGN_g	= 0;
__thread size_t H5T_NATIVE_INT_LEAST64_ALIGN_g	= 0;
__thread size_t H5T_NATIVE_UINT_LEAST64_ALIGN_g	= 0;
__thread size_t H5T_NATIVE_INT_FAST64_ALIGN_g	= 0;
__thread size_t H5T_NATIVE_UINT_FAST64_ALIGN_g	= 0;
...
__thread double H5T_NATIVE_DOUBLE_POS_INF_g      = (double)0.0f;
__thread double H5T_NATIVE_DOUBLE_NEG_INF_g      = (double)0.0f;
...
static __thread hbool_t H5T_top_package_initialize_s = FALSE;
